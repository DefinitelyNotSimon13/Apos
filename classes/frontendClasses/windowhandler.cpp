...
WindowHandler::WindowHandler(ObjectHandler *newObjectHandler) {
    ...
    QObject::connect(launcherWindow, &LauncherWindow::openDevWindow, this, &WindowHandler::showDevWindow,
                     Qt::DirectConnection);
...
void WindowHandler::showDevWindow() {
    ...
    if (devWindow == nullptr) {
        ...
        QObject::connect(devWindow, &DevWindow::returnToLauncher, this, &WindowHandler::showLaunchWindow,
                         Qt::DirectConnection);
        QObject::connect(devWindow, &DevWindow::openSettings, this, &WindowHandler::showSettingsWindow,
                         Qt::DirectConnection);
    }
